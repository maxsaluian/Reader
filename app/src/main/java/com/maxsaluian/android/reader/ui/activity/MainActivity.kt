...
import com.maxsaluian.android.reader.ui.fragment.EntryFragment
import com.maxsaluian.android.reader.ui.fragment.EntryListFragment
import com.maxsaluian.android.reader.ui.fragment.FeedListFragment
...
class MainActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (getFragment(FRAGMENT_MAIN) == null) {
            val feedId = intent?.getStringExtra(EXTRA_FEED_ID)
                ?: Preferences.getLastViewedFeedId(this)
    ...
    companion object {
        ...
        const val EXTRA_FEED_ID = "com.maxsaluian.android.reader.feed_id"
        const val EXTRA_ENTRY_ID = "com.maxsaluian.android.reader.entry_id"
