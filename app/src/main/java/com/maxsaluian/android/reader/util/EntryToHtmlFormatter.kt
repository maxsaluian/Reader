package com.maxsaluian.android.reader.util

import android.util.Base64
import android.util.Base64.encodeToString
import com.maxsaluian.android.reader.data.local.Preferences.FONT_SERIF
import com.maxsaluian.android.reader.data.local.Preferences.TEXT_SIZE_LARGE
import com.maxsaluian.android.reader.data.local.Preferences.TEXT_SIZE_LARGER
...
class EntryToHtmlFormatter(
    ...
    private fun removeStyle(content: String): String {
        ...
        while (base.contains(OPEN_STYLE_TAG)) {
            editedContent =
                base.substringBefore(OPEN_STYLE_TAG) + base.substringAfter(CLOSE_STYLE_TAG)
            base = editedContent
        }
